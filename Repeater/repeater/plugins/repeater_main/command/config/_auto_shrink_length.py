...
async def handle_set_auto_shrink_length(bot: Bot, event: MessageEvent, args: Message = CommandArg()):
    ...
    sendmsg = SendMsg("Chat.Set_Auto_Shrink_Length", set_auto_shrink_length, stranger_info)
    ...
    if sendmsg.is_debug_mode:
        ...
        response = await chat_core.set_config("auto_shrink_length", auto_shrink_length)
